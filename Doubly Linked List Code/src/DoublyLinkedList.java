...
public class DoublyLinkedList <T> implements Iterable <T> {
	...
	//Return the size of this linked list
	  ...
	  public T removeFirst() {
		  ...
		  //Return the data that was at the first node we 
		  //just removed
		  return data;
	  ...
	  public T removeLast() {
		  ...
		  //Remove the data that was just at the first node we just
		  //removed
		  return data;
	  }
	  
	  //Remove7 an arbitrary node from the linked list, O(1)
      ...
      public T removeAt(int index) {
    	  ...
    	  //Search for the back of the list
    	  } else 
